...
namespace Nerv
{
    public partial class ReporteInventarios : Form
    {
        public ReporteInventarios()
        {
            InitializeComponent();
        }

        private void ReporteInventarios_Load(object sender, EventArgs e)
        {
            OcultarSubmenus();
            PosicionarInterfaz();
            PosicionarMenus();
        ...
        {
            MessageBox.Show("Ya estas en esa opción");
        }
